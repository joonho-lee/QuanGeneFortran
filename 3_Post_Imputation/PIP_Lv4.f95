...
integer,allocatable::G012DS(:,:),CG101DS(:,:),NOSMBC(:),IOM(:,:) !data input
...
character(len=24)::IDFN='01_DEF0000_genotypes.out'
character(len=300)::Dummy
character(len=220)::IDD,ODD,GDD
character(len=16)::GDFN
character(len=15)::MWF
character(len=250)::IDFNIP,GDFNIP,ODFNIP,PF
