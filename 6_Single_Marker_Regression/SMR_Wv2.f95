...
! Version : Windows 2.0 (2012-04-09)
...
real::JtJ,JtX,XtJ,XtX,JtY,XtY,YtY,det,mu_hat,g_hat,F_val,tmp,P_val,P_val_F,P_val_t,log10P_val_t,log10P_val_F,log10P_val
...
!reading parameters
print *, "***********************************************************************************************************************" 
print *, "SMR_Lv2 : Single Marker Regression Windows version 2.0"
print *, "Developed by Joonho Lee : zoonolee@gmail.com, +82-10-3408-2895"
print *, "Genotype data form is the results of BEAGLE and of converted genotype 0,1,2"
...
!    print *, "det",det
    ...
    if(TS.eq."f") log10P_val=log10P_val_F
    if(TS.eq."t") log10P_val=log10P_val_F
